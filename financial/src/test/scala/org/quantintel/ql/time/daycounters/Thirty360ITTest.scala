 ...
 * @author Paul Bernard
 */
class Thirty360ITTest extends FlatSpec with Matchers {

  import org.quantintel.lang.numeric._
  import org.quantintel.ql.time.Date
  import org.quantintel.ql.time.daycounters.Thirty360Convention.ITALIAN

  "1. 02/01/07 - 02/28/08" should "be 1.080555556" in {

    val d1 = new Date(1, 2, 2007)
    val d2 = new Date(28, 2, 2008)

    val yf :Double = Thirty360(ITALIAN).yearFraction(d1, d2)

    assert(yf.rounded(9) ==   1.080555556)

  }


  "1a. 01/31/94 - 03/16/1994" should "be 0.127777778" in {
  ...
  "16. 12/15/93 - 12/31/93" should "be 0.041666667" in {
  ...
  "23. 01/15/07 - 01/31/07" should "be 0.041666667" in {
  ...
  "24. 01/31/07 - 02/28/07" should "be 0.083333333" in {
  ...
  "25. 02/28/07 - 03/31/07" should "be 0.083333333" in {
  ...
  "26. 08/31/06 - 02/28/07" should "be 0.5" in {
  ...
  "28. 02/14/07 - 02/28/07" should "be 0.044444444" in {
  ...
  "29. 02/26/07 - 02/29/08" should "be 1.011111111" in {
  ...
  "30. 02/29/08 - 02/28/09" should "be 1.000000000" in {
  ...
  "31. 02/29/08 - 03/30/08" should "be 0.083333333" in {
  ...
  "32. 02/29/08 - 03/31/08" should "be 0.083333333" in {
  ...
  "33. 02/28/07 - 03/05/07" should "be 0.013888889" in {
  ...
  "35. 08/31/07 - 02/29/08" should "be 0.5" in {
  ...
  "36. 02/29/08 - 08/31/08" should "be 0.500000000" in {
    val d1 = new Date(29, 2, 2008)
  ...
  "37. 08/31/08 - 02/28/09" should "be 0.5" in {
  ...
  "38. 02/28/09 - 08/31/09" should "be 0.500000000" in {
