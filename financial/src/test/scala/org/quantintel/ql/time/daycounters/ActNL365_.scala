 ...
 */
class ActNL365_ extends FlatSpec with Matchers  {
...
/*
  "1. 01/31/1990 - 03/16/1991" should "be 1.120547945" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  1.120547945)
  ...
  "2. 05/06/1994 - 10/30/1994" should "be 0.484931507" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==   0.484931507)
  }
  ...
  "3. 01//01/1993 - 02/21/1993" should "be 0.139726027" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.139726027)
  ...
  "4. 02/01/1993 - 03/01/1993" should "be 0.076712329" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.076712329)

  }


  "5. 02/01/1996 - 03/01/1996" should "be 0.076712329" in {
  ...
  "6. 01/01/1993 - 01/01/1994" should "be 1.000000000" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==   1.000000000)
  ...
  "7. 01/15/1993 - 02/01/1993" should "be 0.046575342" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.046575342)
  ...
  "8. 02/15/1993 - 04/01/1993" should "be 0.123287671" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.123287671)
  ...
  "9. 03/31/1993 to 04/30/1993" should "be 0.082191781" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.082191781)
  ...
  "10. 03/31/1993 - 12/31/1993" should "be 0.753424658" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.753424658)
  ...
  "11. 03/15/1993 - 06/15/1993" should "be 0.252054795" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.252054795)
  }
  ...
  "12. 11/01/1993 - 03/01/1994" should "be 0.328767123" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.328767123)
  }
  ...
  "13. 12/31/1993 - 02/01/1994" should "be 0.087671233" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.087671233)
  ...
  "14. 07/15/1993 - 09/15/1993" should "be 0.169863014" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.169863014)
  ...
  "15. 08/21/1993 - 04/11/1994" should "be 0.638356164" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.638356164)
  ...
  "16. 03/31/1993 - 04/01/1993" should "be 0.002739726" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.002739726)
  ...
  "17. 12/15/1993 - 12/31/1993" should "be 0.043835616" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.043835616)
  }
  ...
  "18. 12/15/1993 - 12/30/1993" should "be 0.041095890" in {
    ...
    assert(ActNL365(priorCouponDate, settlementDate).right.get.rounded(9) ==  0.041095890)
  }
*/
