...
/** Test for the 30/360 BMA day count method. A hybrid of the 30E+/360 and 30/360 BMA rules.
 * 
 * @author Paul Bernard
 * @author Peter Mularien
 */
class Thirty360BMATest extends FlatSpec with Matchers {


  import org.quantintel.lang.numeric._
  import org.quantintel.ql.time.Date
  import org.quantintel.ql.time.daycounters.Thirty360Convention.BMA
  ...
  "1. 01/31/94 - 03/16/1994" should "be 0.127777778" in {
    ...
    val yf :Double = Thirty360(BMA).yearFraction(d1, d2)
 ...
 */  
    ...
    assert(yf.rounded(9) ==  0.994444444)
