...
trait Algebra[T] {
   ...
   */
  def dotProduct(another: T) : Double
   ...
   * @return the inner product between this Matrix and another Matrix
   */
  def dotProduct(another: T, from: Int, to: Int) : Double
   ...
   * @return the inner product between this Matrix and another Matrix
   */
  def innerProduct(another: T) : Double
   ...
   * @return the inner product between this Matrix and another Matrix
   */
  def innerProduct(another: T, from: Int, to: Int) : Double
   ...
   */
  def outerProduct(another: T) : Matrix
   ...
   * @return the outer product between this Matrix and another Matrix
   */
  def outerProduct(another: T, from: Int, to: Int) : Matrix
   ...
   * @return an array which contains the computed adjacent differences
   */
  def adjacentDifference(from: Int, to: Int) : T
   ...
   * @return an array which contains the computed adjacent differences
   */
  def adjacentDifference(f : (Double, Double) => Double) : T
   ...
   * @return an array which contains the computed adjacent differences.
   */
  def adjacentDifference(from: Int, to: Int, f: (Double, Double) => Double) : T
   ...
   */
  def min(from: Int, to: Int) : Double
   ...
   */
  def max(from: Int, to: Int) : Double
   ...
   * @return the final sum
   */
  def accumulate(init: Double) : Double
   ...
   * @return the final sum
   */
  def accumulate(from: Int, to: Int, init: Double) : Double
   ...
   */
  def transform( f: (Double, Double) => Double): T
   ...
   */
  def transform(first: Int, last: Int,  f: (Double, Double) => Double) : T
   ...
   * @return an index pointing to the first element "not less than" v, or end() if every element is less than v.
   */
  def lowerBound(from: Int, to: Int, v: Double) : Int
   ...
   * @return an index pointing to the first element not less than v or end() if every element is less than v
   */
  def lowerBound(v: Double,  f: (Double, Double) => Double) : Int
   ...
   * @return an index pointing to the first element not less than v or end() if  every element is less than v
   */
  def lowerBound(from: Int, to: Int, v: Double,  f: (Double, Double) => Double) : Int
   ...
   * @return an index pointing to the first element thatn v or end if no element are greater than v
   */
  def upperBound(first: Int, last: Int, v: Double) : Int
   ...
   */
  def upperBound(v: Double,  f: (Double, Double) => Double) : Int
   ...
   */
  def upperBound(first: Int, last: Int, v: Double,  f: (Double, Double) => Double) : Int
